    ...
    if(isset($_GET['id'])){ 
        ...
        if($cursos->setId($_GET['id']) ){
            ...
            if($data){
                ...
                require_once("../../../app/views/dashboard/maestro/notas/perfiles_view.php");

            }

            else{

                Page::showMessage(4,"No hay perfiles registrados","../perfiles/crear_perfiles.php?=$_SESSION[id1]");
