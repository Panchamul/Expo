...
try{
    ...
    if(isset($_POST['cambiar'])){
        ...
        if($usuario->setId($_SESSION['id1'])){
            if($_POST['clave_actual_1'] == $_POST['clave_actual_2']){
                if($usuario->setClave($_POST['clave_actual_1'])){
                    if($usuario->checkPassword2()){
                        if($_POST['clave_nueva_1'] == $_POST['clave_nueva_2']){
                            if($usuario->setClave($_POST['clave_nueva_1'])){
                                ...
                                if($usuario->changePassword2()){
                                    Page::showMessage(1, "Clave cambiada", "../maestros/menu_maestro.php");
                                }else{
            ...
            Page::showMessage(2, "Usuario incorrecto", "../maestros/menu_maestro.php");
        }
    }
}catch(Exception $error){
    Page::showMessage(2, $error->getMessage(), null);
}
require_once("../../../app/views/dashboard/maestro/account/contrasenia_view.php");
?>