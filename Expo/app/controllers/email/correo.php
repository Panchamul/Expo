...
$correo = $_SESSION['correologinrecuperacionmaestro'];
$codigo = null;
$nombre = null;
$id = null;
...
if(isset($_POST['comparar'])){
    if($_POST['codigo']== $codigo){
        $_SESSION['irchangerecuperacion_maestro'] = $id;
        Page::showMessage(1, "Correcto puedes cambiar tu contraseña", "recuperacion_final.php");
    }else{
