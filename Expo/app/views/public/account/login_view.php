            ...
            <div class="col l3 col m2 col s12 ">  </div>
                ...
                <form method="post" class=" alto1 form-contenedor" autocomplete="off">
                    <div class="row">
                        ...
                        <h5 align=center class="col s12 ">Iniciar Sesion</h5>
                        <div class="input-field col s12 alto3">
                        <!--Logo o icono del input-->
                        <i class="material-icons prefix">account_circle</i>
                        <input id="icon_prefix" name="alias" type="text" class="validate"  value='<?php print($login->getUsuario()) ?>' required>
                        <!--Label del usuario-->
                        ...
                        <input id="icon_prefix" name="clave" type="password" class="validate" value='<?php print($login->getClave()) ?>' required>
                        <!--Label de contraseña-->
                        ...
                        <button type="submit" name="iniciar" class="waves-effect waves-light teal darken-3 btn">Iniciar Sesion</button>  
                        </div>  
