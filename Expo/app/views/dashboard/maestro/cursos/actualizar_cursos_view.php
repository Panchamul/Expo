...
<div class="container">
    <div class="row">
        <div class="col s12">
            <h1 class="  text-blanco" align=center>Actualizar Cursos</h1>
        </div>
    </div>
</div>   
...
<div class="container">
    ...
    <div class="row"> 
        ...
        <div class="input-field blanco col l6 "> 
            <?php
                Page::showSelect("Seleccione una materia", "materias", $curso->getMateria(), $curso->getMaterias());
             ?> 
        </div>    
        <div class="row">
        <div class="col s7 alto3">
            <button class="waves-effect waves-light btn green" name="actualizar" type="submit">Actualizar Curso</button>                
        </div> 
