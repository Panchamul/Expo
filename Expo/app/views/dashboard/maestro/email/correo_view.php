            ...
            <div class="col l3 col m2 col s12 ">  </div>
                ...
                <form method="post" class=" alto1 form-contenedor" autocomplete="off">
                    <div class="row">
                        ...
                        <h5 align=center class="col s12 ">Recuperación de contraseña</h5>
                        <div class="input-field col s12 alto3">
                        <!--Logo o icono del input-->
                        <i class="material-icons prefix">account_circle</i>
                        <input onpaste="return false" id="correo" name="correo" type="email" class="validate"  value='' required>
                        <!--Label del usuario-->
                        ...
                        <button class = "waves-effect waves-light btn black alto3" type="submit" name="enviar">Validar correo</button>
                        </div> 
                    </div> 
                </form>
