...
<div class="container">
    <div class="row">
        <div class="col s12">
            <h1 class="  text-blanco" align=center>Agregar Perfiles</h1>
        </div>
    </div>
</div>   
...
<div class="container">
    ...
    <div class="input-field blanco col s6">
        ...
        <div class="input-field blanco col l6 ">  
                <?php 
                    Page::showSelect("Seleccione un tipo de prueba", "tipos", $perfiles->getTipo(), $perfiles->getTipos()); 
                 ?> 
        </div>   
        <div class="input-field blanco col l6 "> 
        <h6>Selecciona el codigo del curso</h6>
            <?php 
                $perfiles->setMaestro($_SESSION['id1']);
                Page::showSelect("Seleccione un curso", "cursos", $perfiles->getCurso(), $perfiles->getCursos());
             ?> 
        </div>    
        <div class="input-field blanco col s6 ">
     ...
     <select name="meses">
      ...
      <option value="10">Octubre</option>
        ...
        <div class="col s7 alto3">
            <button class="waves-effect waves-light btn green" name="agregar" type="submit">Agregar Perfil</button>                
        </div> 
