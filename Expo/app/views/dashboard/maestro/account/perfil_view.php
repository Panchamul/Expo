...
<main class="hermoso"><!--Completo sirve para que el color llegue a todas partes--> 
    ...
    <div class="row">
        ...
        <div class="input-field blanco col s6">
            ...
            <input onpaste="return false" name="usuario" id="4" type="text" class="validate" value="<?php print($perfil->getUsuario()) ?>" required>
            <label for="4" class="ajuste">Usuario</label> 
        </div> 
        <div class="input-field blanco col s6">
            <!--Input con de tipo text con placeholder de correo-->
            <i class="material-icons prefix">contact_mail</i>
            <input onpaste="return false" name="correo" id="7" type="text" class="validate" value="<?php print($perfil->getCorreo()) ?>" required>
        ...
        foreach($data as $row){ 
         print("
        <div class='col s6'>
        <img id='imgSalida' class='responsive-img' width='250 px' height='250 px' src='../../../web/img/maestros/$row[foto]' />
        </div>
        ");
        }
        ?>  
        ...
        <div class="col s3 alto3">
            <a href="../maestros/menu_maestro.php"class="waves-effect waves-light btn red">Cancelar</a>                
        </div>
        </div>
    </div>
    </div>
