            ...
            <div class="col l3 col m2 col s12 ">  </div>
                ...
                <form class=" alto1 form-contenedor" method="post" autocomplete="off">
                    <div class="row">
                        ...
                        <input onpaste="return false" id="icon_prefix" type="text" name="alias" class="validate">
                        <!--Label del usuario-->
                        ...
                        <input onpaste="return false" id="icon_prefix" type="password" name="clave"class="validate">
                        <!--Label de contraseña-->
                        ...
                        <button name="iniciar" type="submit"class="waves-effect waves-light teal darken-3 btn ">Iniciar Sesion</button>  
                        </div>  
