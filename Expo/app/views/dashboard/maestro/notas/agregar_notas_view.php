...
<div class="container">
    <div class="row">
        <div class="col s12">
            <h1 class="  text-blanco" align=center>Agregar Calificaciones</h1>
        </div>
    </div>
</div>   
  ...
  function filter(__val__){
    ...
    <div class="input-field blanco col s6">
        ...
        <div class="col s7 alto3">
            <button class="waves-effect waves-light btn green" name="agregar" type="submit">Agregar Calificacion</button>                
        </div> 
