        ...
        <div class="row">
            ...
            <form method="post" autocomplete="off">
                <div class="input-field blanco col l12 s12">
                    ...
                    <input onpaste="return false" onkeypress="return soloLetras(event)" name="txtTitulo" placeholder="Titulo" type="text" required value="<?php echo($agendas->getTitulo())?>">
                    <label class="active ">Titulo</label>
                </div>
                <div class="input-field blanco col l12 s12">
                    <!--Input con de tipo text con placeholder de Nombre-->
                    <input onpaste="return false" name="txtCuerpo" onkeypress="return soloLetras(event)"placeholder="Cuerpo" type="text" required value="<?php echo($agendas->getCuerpo())?>">
