<main class="hermoso">
    ...
    <div class="container">
        <div class="row">
            <div class="col s12">
                <h1 class="center text-blanco">Grados dados de baja</h1>
            </div>
        </div>
        <div class="row">
        ...
        <div class="col l12 col s12 col m6 text-blanco">
            <table class="highlight" id="mi_tabla6">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Grados</th>   
                    ...
                    <?php
                        foreach($data as $row){
                            ...
                            <td>'.$row['id'].'</td>
                            <td>'.$row['grado'].'</td>
                            <td><a href="habilitar_gradosok.php?id='.$row['id'].'"  title="Habilitar" class="waves-effect waves-light green btn"><i class="material-icons">check</i></a></td>
                            </tr>
             ...
             <a href='academico.php#tabgrados' title='Cancelar'class='waves-effect waves-light red btn alto3'> cancelar </a>
