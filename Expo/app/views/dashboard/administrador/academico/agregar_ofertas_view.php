<main class="hermoso">
    <div class="container"> 
            <div class="col s12">
                <h1 class="text-blanco center">Agregar Ofertas Academicas</h1>
            </div>
            ...
            <div class="input-field blanco col l6 alto4"> 
                <?php
                    Page::showSelect("Seleccione un Grado", "grados", $oferta->getGrado(), $oferta->getGrados());
                 ?> 
            </div>  
            <div class="input-field blanco col l6 ">
                ...
                <div class="col l5 offset-l1"> 
                        <button type="submit" name="agregar" title="Agregar"class="waves-effect green btn">Agregar Oferta</a>
                 </div>
