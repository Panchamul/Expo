...
<div class="container">
    <div class="row">
        <div class="col s12">
            <h1 class="  text-blanco" align=center>Actualizar maestros</h1>
        </div>
    </div>
</div>   
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col s7 alto3">
            <button class="waves-effect waves-light btn green" name="actualizar" type="submit">Actualizar Maestro</button>                
        </div> 
        <div class="col s3 alto3">
            <a href="ver_maestro.php"class="waves-effect waves-light btn red">Cancelar</a>                
        </div>
        </div>
    </div>
    </div>
