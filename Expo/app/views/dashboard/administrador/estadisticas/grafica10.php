...
require_once("../../../app/controllers/dashboard/administrador/estadisticas/consulta10.php");
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 col l12 col m12 ">
                    ...
                    <div style="width:100%">
                        <canvas id="Chart2" class="white"></canvas>
                        <div class="altura"></div>
                    </div>
                        <!-- jQuery cdn -->
...
//======================================================================================
// chart DOM Element
var ctx = document.getElementById("Chart2");//NOMBRE DEL GRAFICO
      var data = {
        datasets: [{
