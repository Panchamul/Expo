...
require_once("../../../app/controllers/dashboard/administrador/estadisticas/consulta2.php");
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 col l12 col m12 ">
                    <h1 class="text-center">Alumnos con mayor cantidad de códigos muy graves</h1>
