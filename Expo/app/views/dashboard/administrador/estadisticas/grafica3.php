...
require_once("../../../app/controllers/dashboard/administrador/estadisticas/consulta4.php");
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 col l12 col m12 ">
                    <h1 class="text-center">Alumnos con mayor cantidad de códigos positivos</h1>
