...
{ 
    ...
    $this->Cell(0,1,"Carnet : ".$_SESSION['txtcarnet'],0,2,'L',false);    
...
session_start();
$codigos= new Codigo(); 
if($codigos->setIdAlumno($_SESSION['txtcarnet'])){ 
     $data1=$codigos->getCodigoAlumnos1(); 
} 
$fpdf->AddPage();  
$fpdf->titulo();   
if($data1!=null){ 
$fpdf->Ln(1);
$jeje=null; 
$header = array("Codigo","Tipo de codigo","Fecha","Maestro que lo aplico"); 
