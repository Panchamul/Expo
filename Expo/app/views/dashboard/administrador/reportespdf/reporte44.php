...
{ 
    ...
    // celda(ancho en cm,alto en cm,texto para mostrar,borde,ajustar celda,alineacion de la celda,color de fondo)
    $this->Cell(0,1,'Cursos que imparten los docentes  ',0,0,'C',false);  
    $this->Ln();  
}
// Page footer
function Footer()
...
$fpdf->setTitle('Cursos Disponibles');
...
if($curso->setId($row['id'])){
    ...
    $header1=array("Materia","Maestro que la imparte");
    $fpdf->Cell(0.5);
