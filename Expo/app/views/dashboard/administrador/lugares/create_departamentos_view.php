<main class="hermoso">
    <div class="container">
        <div class="row">
            <div class="col s12">
                <h1 class="text-blanco center">Agregar departamentos</h1>
            </div>
            ...
            <form method="post" autocomplete="off">
                <div class="input-field blanco col l12">
                    ...
                    <input onpaste="return false" onkeypress="return soloLetras(event)" name="txtDepartamento" placeholder="Departamento" type="text" required>
