...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="input-field blanco col s6">
            ...
            <input onpaste="return false" name="correo" id="7" type="text" class="validate" value="<?php print($admin->getCorreo()) ?>" required>
        ...
        <div class="input-field blanco col s6">
            ...
            <input onpaste="return false" onkeypress="return soloFechas(event)"name="fecha" id="10" type="text" class="datepicker"  value="<?php print($admin->getFecha()) ?>" required>
        ...
        <div class="input-field blanco col s6">
            ...
            <input onpaste="return false" onkeypress="return solonumeros(event)"name="escalafon" id="12" type="text" class="validate" value=""  >
            <label for="12" class="ajuste">Escalafon</label> 
        </div>  
        <div class="input-field blanco col s6">
            <!--Input con de tipo text con placeholder de usuario-->
            <i class="material-icons prefix">account_circle</i>
            <input onpaste="return false" name="tipousu" id="13" type="text" class="validate" value="" required>
            <label for="13" class="ajuste">Ingresa el nombre del tipo de usuario</label> 
        </div>
