...
<div class="row text-blanco"> 
    ...
    <div class="row">
        ...
        <div class="input-field blanco col s12 m6">
            ...
            <input onpaste="return false" name="contrasenia1" id="1" type="password" class="validate"   required>
            <label for="1" class="ajuste">Ingresa tú contraseña actual</label> 
        </div>
        <div class="input-field blanco col s12 m6">
            <!--Input con de tipo text con placeholder de Nombre-->
            <i class="material-icons prefix">security</i>
            <input onpaste="return false" name="contrasenia2" id="2" type="password" class="validate"  required>
        ...
        <div class="input-field blanco col m6 s12">
            ...
            <i class="material-icons prefix">security</i>
            <input onpaste="return false" name="contrasenia3" id="4" type="password" class="validate"  required>
            <label for="4" class="ajuste">Ingresa tu contraseña nueva</label> 
        </div>    
        <div class="input-field blanco col s12 m6">
            <!--Input con de tipo text con placeholder de telefono-->
            <i class="material-icons prefix">security</i>
            <input onpaste="return false" name="contrasenia4" id="10" type="password" class="validate"  required>
            <label for="10" class="ajuste">Ingresa tu contraseña nueva otra vez</label> 
        </div>   
        <div class="row">
        <div class="col s7 alto3">
            <button class="waves-effect waves-light btn green" name="registrar" type="submit">Cambiar contraseña</button>                
        </div> 
        <div class="col s3 alto3">
            <a href="../account/index.php"class="waves-effect waves-light btn red">Cancelar</a>                
        </div>
        </div>
    </div> 
    </form>  
