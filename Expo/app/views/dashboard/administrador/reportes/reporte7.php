<main class="hermoso">   
  <div class="row  alto1  ajuste">
    <div class=" col l12 col m12 col s12  text-blanco"><h3 align=center >Alumnos reprobados</h3></div>  
      <div class="container "> 
    <div class="col l12 m12 s12">
    <form method="post" action="../../../app/views/dashboard/administrador/reportespdf/reporte7.php" target="_blank" autocomplete="off">  
